    ...
    return (
        <div className='flex flex-col gap-y-2 '>
            ...
            <div className='flex items-center justify-between flex-wrap gap-y-4'>
                ...
                <input type='date' className='border-2 border-gray-300 px-3 py-2 ' onChange={handleChange} name='dateOfBirth'></input>
...
const RegisterContainer = () => {
  ...
  return (
    <div className='w-full px-32 py-4 bg-[#e9eff5] '>
        <div className='p-8 bg-white rounded-lg w-3/4 m-auto '>
